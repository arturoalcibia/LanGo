var destination = document.querySelector(".destination"); // container where selected words go
var origin = document.querySelector(".origin"); // container where words initially start
...
const putback = (word) => {
	...
	word.classList.remove('wordCorrectOrder')
	word.classList.remove('wordIncorrectOrder')
	word.classList.remove('wordIncorrect')
